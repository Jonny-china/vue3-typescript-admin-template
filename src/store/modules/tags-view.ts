...
export interface StoreTagsViewState {
...
class TagsView
  extends VuexModule<StoreTagsViewState>
  implements StoreTagsViewState
{
  public visitedViews: ITagView[] = []
  public cachedViews: (RouteRecordName | undefined)[] = []
...
export const TagsViewModule = getModule<any>(TagsView) as TagsView
