...
export interface StoreErrorLogState {
  logs: IErrorLog[]
}

@Module({ dynamic: true, store, name: 'errorLog', namespaced: true })
class ErrorLog extends VuexModule implements StoreErrorLogState {
