export default {
  ...
  permission: {
    ...
    tips: 'In alcuni casi usare v-permission non ha effetto. Per esempio: Element-Plus  el-tab o el-table-column e altri componenti che renderizzano il dom dinamicamente. Puoi farlo solo con v-if.',
    delete: 'Elimina',
    confirm: 'Conferma',
    cancel: 'Annulla'
  },
  ...
  components: {
    ...
    backToTopTips2:
      'Puoi personalizzare lo stile dei bottoni, mostra / nascondi, altezza di apparizione, altezza del ritorno a capo. Se hai bisogno di un prompt di testo, puoi utilizzare gli elementi element-plus el-tooltip esternamente',
    imageUploadTips:
