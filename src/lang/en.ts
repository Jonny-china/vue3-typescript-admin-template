export default {
  ...
  permission: {
    ...
    tips: 'In some cases, using v-permission will have no effect. For example: Element-Plus  el-tab or el-table-column and other scenes that dynamically render dom. You can only do this with v-if.',
    delete: 'Delete',
    confirm: 'Confirm',
    cancel: 'Cancel'
  },
  ...
  components: {
    ...
    backToTopTips2:
      'You can customize the style of the button, show / hide, height of appearance, height of the return. If you need a text prompt, you can use element-plus el-tooltip elements externally',
    imageUploadTips:
