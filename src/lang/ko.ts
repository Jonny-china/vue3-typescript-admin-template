export default {
  ...
  permission: {
    ...
    roles: '역할',
    switchRoles: '역할 바꾸기',
    tips: 'v-permission 사용할 때가 있습니다. 예 : Element-Plus의 el-tab, el-table-column 및 다른 dom. v-if를 사용해야합니다.',
    delete: '삭제',
    confirm: '확인',
    cancel: '취소'
  },
  ...
  components: {
    ...
    backToTopTips2:
      '버튼 스타일, 표시 / 숨기기, 모양 높이, 반환 높이를 사용자 정의 할 수 있습니다. 텍스트 프롬프트가 필요한 경우 element-plus el-tooltip 요소를 외부에서 사용할 수 있습니다',
    imageUploadTips:
